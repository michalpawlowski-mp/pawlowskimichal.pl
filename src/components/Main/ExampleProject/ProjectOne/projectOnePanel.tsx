        ...
        <div className="flex flex-col p-2">
          <div>
            <div className="flex flex-col text-left my-4">
              ...
              <p className="text-sm mt-1">✅ Sortowanie i filtrowanie treści według kategorii (gry, aktualności, poradniki itp.)</p>
              <p className="text-sm mt-1">✅ Możliwość zapisania ulubionych elementów (np. linków do gier)</p>
              <p className="text-sm mt-1">✅ Rotacja trójkąta wskazująca aktywną opcję sortowania</p>
              <p className="text-sm mt-1">✅ Obsługa wyszukiwania treści</p>
              <p className="text-sm mt-1">✅ Dynamiczna nawigacja między różnymi sekcjami strony</p>
              <p className="text-sm mt-1">✅ Lista linków do stron oferujących gry, recenzje i promocje</p>
              <p className="text-sm mt-1">✅ Dostęp do informacji o nowościach i promocjach w sklepach gier</p>
            </div>
            <div className="flex flex-col text-left">
              <p className="text-xl">Opis</p>
              <p className="text-sm mt-2">
                Platforma umożliwia użytkownikom przeglądanie różnych kategorii treści, takich jak gry, aktualności i poradniki. Każdy użytkownik może filtrować, sortować i przeszukiwać te treści w
                prosty sposób. Użytkownicy mogą również zapisywać ulubione linki do stron z grami lub sklepów, co ułatwia szybki dostęp do interesujących ofert.{" "}
              </p>
          ...
          <div className="relative w-full overflow-hidden">
            ...
            <button onClick={prevSlide} className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-white/20 text-white p-2 rounded-full">
              &#10094;
            </button>
            <button onClick={nextSlide} className="absolute top-1/2 right-0 transform -translate-y-1/2 bg-white/20 text-white p-2 rounded-full">
              &#10095;
            </button>
          </div>
          <div className="flex">
          ...
          <div className="flex">
            <a target="_blank" href="https://michalpawlowski-mp.github.io/GamingHub/" className="flex items-center mt-4 mx-1 py-2 px-5 w-1/2 bg-black/50 text-white rounded-full">
              <img src={web} alt="zobacz projektu w praktyce" className="m-auto invert w-[25px]" />
              <p className="m-auto">Zobacz projekt</p>
            </a>
            <a target="_blank" href="https://github.com/michalpawlowski-mp/GamingHub" className="flex items-center mt-4 mx-1 py-2 px-5 w-1/2 bg-black/50 text-white rounded-full">
