...
import wAppTemp from "/any/WeatherApp/WeatherApp-temp.svg";
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center z-40 items-center backdrop-blur-sm">
      <div className="bg-white/10 shadow-inner shadow-black p-2 rounded-2xl m-1 max-w-3xl w-max">
        ...
        <div className="flex flex-col text-left  p-2 my-4">
          ...
          <p className="text-sm mt-1">✅ Wyświetlanie temperatury, opisu pogody oraz wilgotności</p>
          <p className="text-sm mt-1">✅ Obsługa błędów i informowanie użytkownika o problemach</p>
          <p className="text-sm mt-1">✅ Możliwość wyszukiwania zarówno przyciskiem, jak i klawiszem Enter</p>
        </div>
        <div className="flex flex-col text-left">
          <p className="text-xl">Opis</p>
          <p className="text-sm mt-2">
            Użytkownik wpisuje nazwę miasta w pole tekstowe i naciska przycisk "Pokaż pogodę" lub klawisz Enter. Aplikacja wysyła zapytanie do API OpenWeatherMap, pobiera aktualne dane pogodowe i
            wyświetla je na ekranie w przejrzystej formie. Jeśli miasto nie istnieje lub wystąpił problem z połączeniem, użytkownik otrzymuje odpowiedni komunikat.
          </p>
          <p className="text-sm my-2">Strona posiada nowoczesny i przyjazny interfejs, a dzięki gradientowemu tłu i animacjom zmiana danych odbywa się płynnie.</p>
        </div>
        <div className="flex mt-1 gap-1">
          <img src={wApp} alt="ikona aplikacji pogodowej" className="w-1/2  rounded-xl shadow-md shadow-black" />
          <img src={wAppTemp} alt="ikona temperatury" className="w-1/2  rounded-xl shadow-md shadow-black " />
        </div>
        <div className="flex flex-col">
          <div className="flex flex-wrap mt-5 justify-center">
            ...
            <div className="w-[150px] bg-black/50 p-3  rounded-full m-1 flex items-center justify-center">
              <img src={VITE} alt="ikonka JavaScript" className="w-[20px] mr-2" />
              Vite
            </div>
            <div className="w-[150px] bg-black/50  rounded-full m-1 flex items-center justify-center">
              <img src={API} alt="ikonka JavaScript" className="w-[65px] mr-2" />
              API
            </div>
          </div>
          <div className="flex">
            <a target="_blank" href="https://michalpawlowski-mp.github.io/WeatherApp/" className=" flex items-center mt-4 mx-1 py-2  w-1/2 bg-black/50 text-white rounded-full">
              <img src={web} alt="zobacz projektu w praktyce" className="m-auto invert w-[25px]" />
              <p className="m-auto ml-0">Zobacz projekt</p>
            </a>
            <a target="_blank" href="https://github.com/michalpawlowski-mp/WeatherApp" className="flex items-center mt-4 mx-1 py-2  w-1/2 bg-black/50 text-white rounded-full">
