        ...
        <div className="bg-gray-800 text-gray-300 font-mono overflow-hidden rounded-lg shadow-lg md:w-max w-full">
          ...
          <div className="pl-1 pr-3 text-md md:text-md 2xl:text-lg">
            <div className="flex">
              ...
              <p className="text-blue-400">&lt;web</p>
            ...
            <div>
              <div className="flex">
                ...
                <p className="ml-3 text-blue-400">&lt;hello </p>
                <p className="ml-2 text-blue-200">class</p>
                <p className="text-white">=</p>
            ...
            <div>
              ...
              <div className="flex">
                ...
                <p className="ml-7 text-red-400">
                  Tworzę nowoczesne, dynamiczne oraz
                </p>
              </div>
              <div className="flex">
