      ...
      <div className="bg-white/10 shadow-inner shadow-black p-2 rounded-2xl mx-2 max-w-3xl w-full h-5/6 overflow-auto">
        ...
        <div className="flex flex-col p-2">
          ...
          <div className="relative w-full overflow-hidden">
            <img src={clonetube} alt="ikona aplikacji pogodowej" className="w-1/2  rounded-xl shadow-md shadow-black" />
          </div>
          <div className="flex flex-wrap mt-5 justify-center">
            ...
            <div className="w-1/3 bg-black/50 p-1 rounded-full m-2 flex items-center justify-center">
              <img src={typescript} alt="ikonka CSS" className="w-[20px]" />
              Typescript
            </div>
            <div className="w-1/3 bg-black/50 p-1 rounded-full m-2 flex items-center justify-center">
              <img src={tailwind} alt="ikonka CSS" className="w-[20px]" />
              Tailwind
            </div>
          </div>
          <div className="flex flex-wrap justify-center">
            ...
            <div className="w-1/3 bg-black/50 p-2 px-5 rounded-full m-2 flex items-center justify-center">
              <img src={nextjs} alt="ikonka JavaScript" className="w-[20px]" />
              Next.js
            </div>
            <div className="w-[150px] p-1 bg-black/50  rounded-full m-1 flex items-center justify-center">
              <img src={vercel} alt="ikonka JavaScript" className="w-[40px] mx-2" />
              Vercel
            </div>
            <div className="w-[150px] p-1 bg-black/50  rounded-full m-1 flex items-center justify-center">
          ...
          <div className="flex">
            <a
              target="_blank"
              href={"https://michalpawlowski-mp.github.io/CloneTube/"}
