    ...
    <section className="w-full flex flex-col md:flex-row items-center justify-around px-6 md:px-16 py-5">
      <div className="flex flex-col items-start gap-6 text-center md:text-left">
        ...
        <p className="text-lg md:text-xl text-gray-200 max-w-xl">
          Jestem Michał i rozwijam się w kierunku frontendu. Uczę się nowych technologii, tworzę własne projekty i stale
          poszerzam swoje umiejętności.
        </p>
        <ButtonContact />
      </div>
      <div className="flex justify-center md:mt-0">
        <img src={me} alt="Michał Pawłowski" width={400} height={400} className="rounded-3xl shadow-lg m-3" />
      </div>
    </section>
  );
}
