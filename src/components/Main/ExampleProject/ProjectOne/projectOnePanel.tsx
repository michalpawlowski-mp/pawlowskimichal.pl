...
import clonetubeTwo from "/any/CloneTube/clonetubeviewvideo.svg";
        ...
        <div className="flex flex-col p-2">
          ...
          <div className="flex flex-wrap mt-5 justify-center">
            ...
            <div className="w-[150px] bg-black/50 p-1 rounded-full m-1 flex items-center justify-center">
              <img src={typescript} alt="ikonka CSS" className="w-[25px] mx-2" />
              Typescript
            </div>
            <div className="w-[150px] bg-black/50 p-1 rounded-full m-1 flex items-center justify-center">
              <img src={tailwind} alt="ikonka CSS" className="w-[25px] mx-2" />
              Tailwind
            </div>
          </div>
          <div className="flex flex-wrap justify-center">
            ...
            <div className="w-[150px] bg-black/50 p-1 px-5 rounded-full m-1 flex items-center justify-center">
              <img src={nextjs} alt="ikonka JavaScript" className="w-[25px] invert mx-2" />
              Next.js
            </div>
