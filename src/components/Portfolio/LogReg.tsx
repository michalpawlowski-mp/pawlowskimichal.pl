    ...
    <>
      <div className="w-[400px] bg-black/70 text-center flex flex-col items-center justify-center border-2 overflow-hidden border-white rounded-2xl m-5 shadow-lg">
        <div className="flex w-full justify-center items-center border-b-2 border-white">
          ...
          <p className="text-2xl overflow-hidden w-full  p-2">Formularz Logowania/Rejestracji</p>
        </div>
        ...
        <div className="flex justify-center w-full ">
          <a href="https://github.com/michalpawlowski-mp/Login-Registration" target="_blank" className="hover:bg-white/20 w-1/2 border-r-2 flex items-center justify-center">
            <img src={github} alt=" link do GitHub" className="w-6 h-6 m-2 invert" />
          </a>
          <a href="https://michalpawlowski-mp.github.io/Login-Registration/" target="_blank" className="hover:bg-white/20 w-1/2 flex items-center justify-center">
