...
import xo from "/any/XO/kik.svg";
import xor from "/any/XO/kik-r.svg";
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center z-40 items-center backdrop-blur-sm">
      <div className="bg-white/10 shadow-inner shadow-black p-2 rounded-2xl m-1 max-w-3xl w-max">
        ...
        <div className="flex flex-col text-left  p-2 my-4">
          ...
          <p className="text-sm mt-1">✅ Interaktywna plansza 3x3 do gry w „Kółko i Krzyżyk”</p>
          ...
          <p className="text-sm mt-1">✅ Komunikaty informujące o stanie gry (czyja kolej, kto wygrał)</p>
          <p className="text-sm mt-1">✅ Możliwość restartu gry jednym przyciskiem</p>
        </div>
        <div className="flex flex-col text-left">
          <p className="text-xl">Opis</p>
          <p className="text-sm mt-2">
            Gra rozpoczyna się od planszy 3x3, na której gracze na zmianę umieszczają swoje symbole (X lub O). Po każdym ruchu aplikacja sprawdza, czy któryś z graczy wygrał lub czy nastąpił remis. Po
            zakończeniu gry można uruchomić nową rozgrywkę za pomocą przycisku „Restart”.
          </p>
          <p className="text-sm my-2">Projekt został zaprojektowany z myślą o prostocie i wygodzie użytkowania, oferując płynną animację oraz intuicyjne interakcje..</p>
        </div>
        <div className="flex mt-1 gap-1">
          <img src={xo} alt="ikona aplikacji pogodowej" className="w-1/2  rounded-xl shadow-md shadow-black" />
          <img src={xor} alt="ikona temperatury" className="w-1/2  rounded-xl shadow-md shadow-black " />
        </div>
        <div className="flex flex-col">
          ...
          <div className="flex">
            <a target="_blank" href="https://michalpawlowski-mp.github.io/X-O/" className=" flex items-center mt-4 mx-1 py-2 px-5 w-1/2 bg-black/50 text-white rounded-full">
              <img src={web} alt="zobacz projektu w praktyce" className="m-auto invert w-[25px]" />
              <p className="m-auto">Zobacz projekt</p>
            </a>
            <a target="_blank" href="https://github.com/michalpawlowski-mp/X-O" className="flex items-center mt-4 mx-1 py-2 px-5 w-1/2 bg-black/50 text-white rounded-full">
